        ...
        <div>
            ...
            <div className="flex">
                ...
                <div className="font-code mt-10 w-screen text-center">
                    <p className="text-8xl">MR. SILLY</p>
                    <div className="mt-10">PLACE FOR SOME MORE CONTENT</div>
                    <p className="text-4xl mt-10">Hello user!</p>
                    <div className="text-1xl text-justify mt-5 mx-28">
                        <p>It's a website for my game. You can play it online. The link is here: If you want to learn a bit more about the game stay here!</p>
                        ...
                        <p>To get a "friend" status you can either: be my friend, or: contact me and ask for the status update. For now, on every page you can leave comments bellow posts where it's allowed.</p>
